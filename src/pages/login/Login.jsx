      ...
      <section className='bg-white dark:bg-gray-900'>
        <div className='flex flex-col items-center justify-center px-6 py-8 mx-auto md:h-screen lg:py-0'>
          ...
          >
            <img
              src={Logo}
              className='inline-block w-32 h-32 transition-transform duration-1000 delay-500 transform sm:h-16 sm:w-16 md:w-32 md:h-32 rotate-360'
              alt='Flowbite Logo'
            />
          </a>
          <div className='w-full bg-white rounded-lg shadow dark:border md:mt-0 sm:max-w-md xl:p-0 dark:bg-gray-800 dark:border-gray-700'>
            <div className='p-6 space-y-4 md:space-y-6 sm:p-8'>
              ...
              >
                ...
                <button
                  type='submit'
                  className='w-full text-white bg-red-900 hover:bg-black focus:ring-4 focus:outline-none focus:ring-primary-300 font-medium rounded-lg text-base px-5 py-2.5 text-center dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800'
                >
                  Sign in
                </button>
              </form>
